...
function onCreateWebpackConfig({
  ...
  if (stage === `develop`) {
    ...
    try {
      ...
      reporter.warn(`"typescript" is not installed. Builtin ESLint won't be working on typescript files.`);
    }
    ...
    if (isTypescriptDepAvailable) {
      ...
      if (builtInEslintRule) {
        const typescriptEslintRule = Object.assign({}, builtInEslintRule, {
          test: /\.tsx?$/
        });
        actions.setWebpackConfig({
          module: {
